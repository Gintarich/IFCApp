...
public class TeklaWindowConfig
{

    public TeklaWindowConfig()
    {
    }
    ...
    private TS.Component GetSandwichConfig(SandwichPanel sandwichPanel)
    {
        ...
        opening.SetAttribute("B_wood.material", "Klima Konform");
        ...
        opening.SetAttribute("L_wood.material", "Klima Konform");
